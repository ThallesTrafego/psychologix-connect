        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="w-full lg:w-1/2 order-2 lg:order-1 reveal">
            ...
            <h2 className="text-3xl md:text-4xl font-display text-psycho-text mb-4">
              Olá, sou Dra. Ana Silva
            </h2>
            <p className="text-psycho-text/80 mb-4">
              Psicóloga clínica formada pela Universidade Federal de Santa Maria (UFSM), com especialização em Terapia Cognitivo-Comportamental e mais de 10 anos de experiência no atendimento de adultos e adolescentes.
            </p>
            <p className="text-psycho-text/80 mb-6">
              Minha abordagem é integrativa e personalizada, considerando aspectos cognitivos, emocionais e comportamentais. Acredito no potencial de cada pessoa para superar desafios e encontrar seu equilíbrio emocional.
            </p>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <div className="flex items-center gap-2 bg-psycho-light/50 px-4 py-2 rounded-full">
                ...
                <span className="text-sm text-psycho-text">CRP 07/12345</span>
              </div>
              <div className="flex items-center gap-2 bg-psycho-light/50 px-4 py-2 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5 text-psycho-main">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-sm text-psycho-text">10+ anos de experiência</span>
              </div>
            </div>
            ...
            <ContactButton 
              ...
              variant="primary"
              size="md"
              message="Olá Dra. Ana, gostaria de agendar uma consulta!"
            />
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative z-10 rounded-2xl overflow-hidden shadow-lg bg-white p-2">
                <img 
                  ...
                  alt="Dra. Ana Silva, psicóloga em Santa Maria" 
